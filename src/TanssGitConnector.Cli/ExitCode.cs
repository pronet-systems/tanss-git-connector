...
/// </summary>
/// <remarks>
/// <para>Sie sind ein Vertrag, kein Anzeigedetail: Eine Überwachung ruft <c>tanss-git doctor</c>
...
///
/// <para><see cref="Usage"/> steht bewusst abseits der Skala 0/1/2: Ein Tippfehler im Aufruf ist
/// keine Aussage über die Gesundheit der Einrichtung. Der Wert 64 ist der übliche
/// <c>EX_USAGE</c>.</para>
/// </remarks>
public static class ExitCode
{
    ...
    /// <summary>Gestört: In diesem Zustand geht Arbeitszeit verloren oder kommt nicht an.</summary>
